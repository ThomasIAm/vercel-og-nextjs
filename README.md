...
css: Tailwind
deployUrl: https://vercel.com/new/clone?repository-url=https://github.com/ThomasIAm/vercel-og-nextjs/tree/main&project-name=vercel-og-nextjs&repository-name=vercel-og-nextjs
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/ThomasIAm/vercel-og-nextjs/tree/main&project-name=vercel-og-nextjs&repository-name=vercel-og-nextjs)
...
```bash
pnpm create next-app --example https://github.com/ThomasIAm/vercel-og-nextjs/tree/main
```
